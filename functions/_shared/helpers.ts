...
const BUILT_IN_TEMPLATES = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'cost', label: '임차료·취득가액 및 부대비용', type: 'textarea', required: true, width: 'full' },
      { id: 'insurance', label: '보험가입·보장범위', type: 'textarea', required: true, width: 'full' },
      { id: 'management', label: '운행일지·주유·정비·보관 계획', type: 'textarea', required: true, width: 'full' },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'contractConsent', label: '계약상대방 승계동의·요건', type: 'textarea', required: true, width: 'full' },
      { id: 'remainingValue', label: '잔여리스료·보증금·정산금', type: 'textarea', required: true, width: 'full' },
      { id: 'priceBasis', label: '승계대가·시가 산정근거', type: 'textarea', required: true, width: 'full' },
      { id: 'lossCheck', label: '법인 추가채무·위약금·손해 검토', type: 'textarea', required: true, width: 'full' },
      { id: 'operationImpact', label: '업무용 차량 운영·대체차량 영향', type: 'textarea', required: true, width: 'full' },
      { id: 'recusal', label: '이해관계인 의결회피 여부', type: 'text', required: true, width: 'half' },
